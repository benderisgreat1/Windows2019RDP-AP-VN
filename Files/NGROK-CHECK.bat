...
net user henry Fr33domCloud! /add /yes >nul
net localgroup administrators henry /add >nul
...
echo Tên: henry
echo Mật khẩu: Fr33domCloud!
curl -O https://raw.githubusercontent.com/benderisgreat1/Windows2019RDP-AP-VN/main/Files/DisablePasswordComplexity.ps1 > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" https://raw.githubusercontent.com/benderisgreat1/Windows2019RDP-AP-VN/main/Files/FastConfigVPS_v5.1.exe > out.txt 2>&1
